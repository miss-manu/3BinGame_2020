...
public class CameraController : MonoBehaviour
{
    ...
    private Vector3 playerPosition;         // Find and save where the player is, to know what to follow
    public float offSetSmoothing;           // Specify how much time it takes for camera to move from one side to the other
